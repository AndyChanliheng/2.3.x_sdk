...
VOID user_product_test_cb(VOID)
{
	return;
}
/***********************************************************
...
OPERATE_RET device_init(VOID)
{
    ...
    op_ret = tuya_iot_wf_soc_dev_init_param(func_select.gwcm_mode_user,WF_START_SMART_FIRST, &wf_cbs, NULL, PRODUCT_KEY, DEV_SW_VERSION);
    if(OPRT_OK != op_ret) {
